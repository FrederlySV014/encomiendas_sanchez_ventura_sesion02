...
class Encomienda(models.Model):
    ...
    def calcular_costo(self):
        """
        Calcula el costo del envío basándose en:
    ...
    def clean(self):
        ...
        # Regla 1: remitente y destinatario no pueden ser iguales
        ...
        # Regla 2: fecha estimada no puede ser en el pasado
        ...
        # Regla 3: fecha real no puede ser menor que la estimada
